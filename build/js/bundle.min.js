function cambiarFondo(t,e){const i=document.querySelector(".banner"),n=document.querySelectorAll(".content");i.style.background=`url("./build/img/movies/${t}")`,i.style.backgroundSize="cover",i.style.backgroundPosition="center",n.forEach(t=>{t.classList.remove("active"),t.classList.contains(e)&&t.classList.add("active")})}
/*!
